...
$Configuration = @{
    ...
    UsersPerCity    = @{
        "Major"  = 500     # Grandes villes (capitales, métropoles)
        "Large"  = 200     # Grandes villes
        "Medium" = 100    # Villes moyennes
        "Small"  = 50      # Petites villes
    }
}
...
function Get-CitySize {
    ...
    # Les 3 premières villes de chaque pays sont considérées comme moyennes
...
# Générer automatiquement la liste des villes avec utilisateurs
$Cities = @()
